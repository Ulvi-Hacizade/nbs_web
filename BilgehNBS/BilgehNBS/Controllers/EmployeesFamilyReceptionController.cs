...
namespace BilgehNBS.Controllers
{
    ...
    public class EmployeesFamilyReceptionController : ControllerBase
    {



        [HttpGet]
        public IActionResult EmployeesReception()
        {
            ...
            var employeEntity = DB.EmployeeRepository.Get().Where(x => x.IsGuestInviter.Equals(false) && x.IsReception.Equals(true)).ToList();
            ...
            return View("EmployeesReception", EmployeeModelList);
        }
        ...
        public IActionResult EmployeeExit(string MemberId, string type, string inputOutput, string note, string time)
        {
