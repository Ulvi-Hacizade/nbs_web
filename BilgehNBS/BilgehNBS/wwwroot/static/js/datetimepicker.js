        ...
        return this.each(function () {
            ...
            elem.on('click', function () {
                ...
                function createMonthPanel(selectMonth) {
                    ...
                    $s.bind('click', prevMonth.bind(null, ['year']));
                    $d.append($s);

                    //-----------------------
                    var $s = $('<i></i>');
                    $s.addClass('fa fa-angle-left cursorily ico-size-month hov');
                    $s.bind('click', prevMonth.bind(null, ['month']));
                    $d.append($s);
                    ...
                    $s.bind('click', nextMonth.bind(null, ['month']));
                    $d.append($s);

                    //------------------------------------
                    $s = $('<i></i>');
                    $s.addClass('fa fa-angle-right cursorily ico-size-month hov');
                    $s.bind('click', nextMonth.bind(null, ['year']));
                    $d.append($s);
                    return $d;
                }
